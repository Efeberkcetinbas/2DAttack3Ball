...
public class PlayerManager : MonoBehaviour
{
    ...
    public void OpenSignal()
    {
        for (int i = 0; i < balls.Count; i++)
        {
            ...
            balls[i].GetComponent<PlayerMovement>().canShoot=false;    
        }
        ...
        balls[index].GetComponent<PlayerMovement>().canShoot=true;    
    }

    public void IncreaseIndex()
    {
        balls[index].GetComponent<PlayerMovement>().canShoot=false;
        index++;
    }
